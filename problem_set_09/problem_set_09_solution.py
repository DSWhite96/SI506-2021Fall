...
class Languages():
    ...
    def add_language(self, species):
        ...
        if language in self.language_database.keys():
            self.language_database[language].append((species['name'], species['homeworld']))
        else:
            self.language_database[language] = [(species['name'], species['homeworld'])]
...
def fill_language_database(species_data, language_database):
    ...
    for species in species_data:
        if species['name'] == 'Droid':
            continue
        species['homeworld'] = get_swapi_resource(species['homeworld'])['name']
